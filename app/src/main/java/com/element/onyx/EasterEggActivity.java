...
public class EasterEggActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_learn_more).setOnTouchListener(mDelayHideTouchListener);
    }
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        Button button_learn_more = (Button) findViewById(R.id.button_learn_more);

        button_learn_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // Send intent to open Onyx's website

                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://onyxai.cf/")));
